...
After downloading all 7 databases, place them in the same path as this GitHub repository (previously cloned or downloaded). Then, download the **[AI4Food-NutritionDB.txt](http://atvs.ii.uam.es/atvs/2022/models/)** and also place it in the same path as before. Finally, run **database_generation.py** and wait until the database is properly generated! Once this last step is done, the AI4Food-NutritionDB database will be available. As mentioned in the paper, the database is organised into 19 major categories, 73 subcategories, and 911 final products.
